 ...
 * @author MSI
 */
@WebServlet(name = "updateRoomOwnwer", urlPatterns = {"/updateRoomOwner"})
public class updateRoomOwner extends HttpServlet {
	...
	HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE room SET owner= ? WHERE rid = ?"; 

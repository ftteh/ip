    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="/ip/admin/ManageBackendDataServlet"><span class="glyphicon glyphicon-th-list"></span>
              Manage Backend Data</a></li>
        </ul>
    ...
    <div class="well">
      <div class="row">
              ...
              <tbody>
                <c:forEach items="${sessionScope.currencylist}" var="currentcurr" varStatus="loop">
                  <tr>
                    ...
                    <td><a href="<c:out value='${displayURLEdit}' />">
                        <c:out value="${currentcurr.name}" /></a></td>
                    <td>
                      <c:out value="${currentcurr.symbol}" />
                    </td>
                    ...
                    <c:if test="${currentcurr.status == 'active'}">
                      ...
                      <td><a href="<c:out value='${displayURLDeactivate}' />">
                    ...
                    <c:if test="${currentcurr.status == 'deactivate'}">
                      ...
                      <td><a href="<c:out value='${displayURLActivate}' />">
                          <c:out value="${currentcurr.status}" /></a></td>
                    </c:if>
        ...
        <div class="col-md-5">
          ...
          <div class="well">
            <form class="form-horizontal" action="/ip/adminRegisterCurrencyServlet" method="post">
              <fieldset>
